...
from tests.models import Account, Address, ContactForm, Customer, Email, Note, Payment, ChildE
from .data import (
...
class TestModelAnonymization(AnonymizedDataMixin, NotImplementedMixin, TestCase):
    ...
    def test_email(self):
        self.email  = Email(customer=self.customer, email=CUSTOMER__EMAIL)
        self.email.save()
        self.email._anonymize_obj(base_encryption_key=self.base_encryption_key)
        anon_email  = Email.objects.get(pk=self.email.pk)
    ...
    def test_address(self):
        ...
        anon_address  = Address.objects.get(pk=self.address.pk)
    ...
    def test_account(self):
        ...
        anon_account = Account.objects.get(pk=self.account.pk)
    ...
    def test_payment(self):
        ...
        anon_payment = Payment.objects.get(pk=self.payment.pk)
    ...
    def test_contact_form(self):
        ...
        anon_contact_form = ContactForm.objects.get(pk=self.contact_form.pk)
    ...
    def test_anonymization_field_matrix_related(self):
        related_email = Email(customer=self.customer, email=CUSTOMER__EMAIL)
        related_email.save()
        ...
        anon_related_email = Email.objects.get(pk=related_email.pk)
    ...
    def test_reverse_generic_relation(self):
        ...
        anon_note2 = Note.objects.get(pk=note.pk)
    ...
    def test_irreversible_deanonymization(self):
        contact_form = ContactForm(email=CUSTOMER__EMAIL, full_name=CUSTOMER__LAST_NAME)
        contact_form.save()
    ...
    def test_generic_relation_anonymizer(self):
        ...
        anon_contact_form = ContactForm.objects.get(pk=contact_form.pk)
    ...
    def test_reversion_anonymization(self):
        ...
        versions = get_reversion_versions(form)
        ...
        anon_versions = get_reversion_versions(form)
        ...
        deanon_versions = get_reversion_versions(form)
    ...
    def test_reversion_anonymization_parents(self):
        ...
        versions_a = get_reversion_versions(e.topparenta_ptr)
        versions_b = get_reversion_versions(e.parentb_ptr)
        versions_c = get_reversion_versions(e.parentc_ptr)
        versions_d = get_reversion_versions(e.extraparentd_ptr)
        versions_e = get_reversion_versions(e)
        ...
        anon_versions_a = get_reversion_versions(e.topparenta_ptr)
        anon_versions_b = get_reversion_versions(e.parentb_ptr)
        anon_versions_c = get_reversion_versions(e.parentc_ptr)
        anon_versions_d = get_reversion_versions(e.extraparentd_ptr)
        anon_versions_e = get_reversion_versions(e)
        ...
        deanon_versions_a = get_reversion_versions(e.topparenta_ptr)
        deanon_versions_b = get_reversion_versions(e.parentb_ptr)
        deanon_versions_c = get_reversion_versions(e.parentc_ptr)
        deanon_versions_d = get_reversion_versions(e.extraparentd_ptr)
        deanon_versions_e = get_reversion_versions(e)
